...
(function() {
	...
	function init() {
		...
		showMenu.addEventListener( clickevent, function( ev ) {
			...
			// Copied this from bellow to allow the button closing the menu as well
			if( classie.has( perspectiveWrapper, 'animate') ) {
				...
				// added in to swap icon
				//showMenu.innerHTML = '<i class="fa fa-bars fa-3x"></i>';

			} else {

				// added in to swap icon
				//showMenu.innerHTML = '<i class="fa fa-times fa-3x"></i>';
